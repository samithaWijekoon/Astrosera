...
const BADGE_BLUEPRINTS = {
    combo: [
        ...
        { id: 'cb3', image: badgeImage('cb3.png'), name: 'Rising Constellation', desc: '9 days of consistency shining bright.', color: '#8b5cf6' },
        { id: 'cb4', image: badgeImage('cb4.png'), name: 'Solar Pathfinder', desc: '12 days streak, blazing your path.', color: '#7e22ce' },
        { id: 'cb5', image: badgeImage('cb5.png'), name: 'Galaxy Runner', desc: '15 days streak, reaching new heights.', color: '#c084fc' },
        { id: 'cb6', image: badgeImage('cb6.png'), name: 'Nebula Voyager', desc: '18 days streak, exploring further.', color: '#d946ef' },
        { id: 'cb7', image: badgeImage('cb7.png'), name: 'Orbit Master', desc: '21 days streak, mastery in progress.', color: '#a855f7' },
        { id: 'cb8', image: badgeImage('cb8.png'), name: 'Cosmic Titan', desc: '24 days streak, strong and unstoppable.', color: '#9333ea' },
        { id: 'cb9', image: badgeImage('cb9.png'), name: 'Supernova Force', desc: '27 days streak, bursting with power.', color: '#8b5cf6' },
        { id: 'cb10', image: badgeImage('cb10.png'), name: 'Galactic Legend', desc: '30 days streak, ultimate achievement.', color: '#c084fc' },
    ],
    mission: [
        { id: 'mm1', image: badgeImage('mm1.png'), name: 'Light Speed', desc: 'Finish a quiz under 2 minutes for the first time.', color: '#a855f7' },
        { id: 'mm2', image: badgeImage('mm2.png'), name: 'Photon Mind', desc: 'Finish quizzes under 2 minutes 3 times.', color: '#9333ea' },
        { id: 'mm3', image: badgeImage('mm3.png'), name: 'Nova Burst', desc: 'Finish quizzes under 2 minutes 5 times.', color: '#8b5cf6' },
        { id: 'mm4', image: badgeImage('mm4.png'), name: 'Solar Flare', desc: 'Get full marks for the first time in a quiz.', color: '#7e22ce' },
        { id: 'mm5', image: badgeImage('mm5.png'), name: 'Mission Legend', desc: 'Pass 5 times in quizzes without failing.', color: '#d946ef' },
        { id: 'mm6', image: badgeImage('mm6.png'), name: 'Mission Commander', desc: 'Pass 10 times in quizzes without failing.', color: '#a855f7' },
        { id: 'mm7', image: badgeImage('mm7.png'), name: 'Boss Mission', desc: 'Pass 20 times in quizzes without failing.', color: '#9333ea' },
        { id: 'mm8', image: badgeImage('mm8.png'), name: 'Stable Signal', desc: 'Get the same score 3 times in a row.', color: '#c084fc' },
        { id: 'mm9', image: badgeImage('mm9.png'), name: 'Twin Signal', desc: 'Get the same score for 2 consecutive days.', color: '#8b5cf6' },
        { id: 'mm10', image: badgeImage('mm10.png'), name: 'Supernova Growth', desc: 'Get a new personal best in a quiz.', color: '#d946ef' },
    ],
    totalDays: [
        { id: 'td1', image: badgeImage('td1.png'), name: 'Comet Spark', desc: '1 week of interaction, first milestone.', color: '#a855f7' },
        { id: 'td2', image: badgeImage('td2.png'), name: 'Orbit Rookie', desc: '2 weeks, keeping the streak alive.', color: '#9333ea' },
        { id: 'td3', image: badgeImage('td3.png'), name: 'Star Voyager', desc: '1 month of daily visits.', color: '#8b5cf6' },
        { id: 'td4', image: badgeImage('td4.png'), name: 'Cosmic Trailblazer', desc: '1.5 months, strong streak.', color: '#7e22ce' },
        { id: 'td5', image: badgeImage('td5.png'), name: 'Nebula Explorer', desc: '2 months, exploring consistently.', color: '#a855f7' },
        { id: 'td6', image: badgeImage('td6.png'), name: 'Solar Navigator', desc: '3 months of daily dedication.', color: '#c084fc' },
        { id: 'td7', image: badgeImage('td7.png'), name: 'Galaxy Runner', desc: '4 months, streaking through the stars.', color: '#d946ef' },
        { id: 'td8', image: badgeImage('td8.png'), name: 'Stellar Commander', desc: 'Half a year, commanding the cosmos.', color: '#a855f7' },
