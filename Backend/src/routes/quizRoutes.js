...
const { uploadQuizExcel, getQuizzes, clearQuizzes, getQuizStatus, getRandomQuiz } = require('../controllers/quizController');
...
// Path: GET /api/quiz/random
// Used by Home page widget (unprotected so guests can see it)
